module.exports = {
  apps: [
    ...
    {
      name: 'orb-bot',
      script: './clients/bot-dashboard/orb-trading-bot.js',
      cwd: '/Users/theophilusogieva/Desktop/NexusTradeAI',
      instances: 1,
      autorestart: true,
      watch: false,
      ...
      env: {
        NODE_ENV: 'production',
        TRADING_PORT: 3003  // Changed to avoid conflict
      },
      error_file: './clients/bot-dashboard/logs/orb-bot-error.log',
      out_file: './clients/bot-dashboard/logs/orb-bot-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
      min_uptime: '10s',
      max_restarts: 10,
    ...
    {
      name: 'gap-fade-bot',
      script: './clients/bot-dashboard/gap-fade-bot.js',
      cwd: '/Users/theophilusogieva/Desktop/NexusTradeAI',
      instances: 1,
      autorestart: true,
      watch: false,
      ...
      error_file: './clients/bot-dashboard/logs/gap-fade-bot-error.log',
      out_file: './clients/bot-dashboard/logs/gap-fade-bot-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
      min_uptime: '10s',
      max_restarts: 10,
    ...
    {
      name: 'hvb-bot',
      script: './clients/bot-dashboard/high-volume-breakout-bot.js',
      cwd: '/Users/theophilusogieva/Desktop/NexusTradeAI',
      instances: 1,
      autorestart: true,
      watch: false,
      ...
      error_file: './clients/bot-dashboard/logs/hvb-bot-error.log',
      out_file: './clients/bot-dashboard/logs/hvb-bot-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
      min_uptime: '10s',
      max_restarts: 10,
